...
from api.serializers import PostSerializer, MediaSerializer, CommentSerializer, UserSerializer
from api.permissions import IsAuthiticantedAndAuthor, isAuthenticatedAndDone
...
class PostViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        if self.action == "list":
            ...
            permission_classes = [IsAuthiticantedAndAuthor()]
        else:
            permission_classes = [AllowAny()]
    ...
    def users_liked_post(self, request, pk=None):
        ...
        serializer = UserSerializer(post.liked_users.all(), many=True)
        return Response(serializer.data)
    ...
    def users_viewed_posts(self, request, pk=None):
        post = self.get_object()
        serializer = UserSerializer(post.viewed_users.all(),many=True)
        return Response(serializer.data)
